...
class library{
	...
	/*----------- Tính convert viet sang english ---------------*/
	...
	/*------------- Hàm select list ----------------*/
	    ...
	    public function getList_home_1($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	        ...
	        if ($id_Cat != "" && $name_idCat != "") {
	            ...
	            $now = date('Y-m-d');
	            $where = "WHERE thong_tin_tuyen_dung.level in (1,2,3,4,5) AND thong_tin_tuyen_dung.home = 1 AND nha_tuyen_dung.home_time >= '$now'";
	        ...
	        $sql = "SELECT * From $table INNER JOIN nha_tuyen_dung ON $table.nha_tuyen_dung_id = nha_tuyen_dung.id $where $order $limit1";
	    ...
	    public function getList_home_2($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	        ...
	        if ($id_Cat != "" && $name_idCat != "") {
	            ...
	            $now = date('Y-m-d');
	            $where = "WHERE thong_tin_tuyen_dung.level in (6,7,8,9) AND thong_tin_tuyen_dung.home = 1 AND nha_tuyen_dung.home_time >= '$now'";
	    ...
	    public function getList_tuyen_1($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	        ...
	        if ($id_Cat != "" && $name_idCat != "") {
	            ...
	            $now = date('Y-m-d');
	            $where = "WHERE thong_tin_tuyen_dung.level in (1,2,3,4,5) AND thong_tin_tuyen_dung.trang_tuyen = 1 AND nha_tuyen_dung.tuyen_time >= '$now'";
	    ...
	    public function getList_tuyen_2($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	        ...
	        if ($id_Cat != "" && $name_idCat != "") {
	            ...
	            $now = date('Y-m-d');
	            $where = "WHERE thong_tin_tuyen_dung.level in (6,7,8,9) AND thong_tin_tuyen_dung.trang_tuyen = 1 AND nha_tuyen_dung.tuyen_time >= '$now'";
	    ...
	    public function getList_ajax($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	    ...
	    public function getList_arr($table, $arr, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	    ...
	    public function getList_admin_ungvien($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	        ...
	        if (isset($_GET['name'])) {
	        	$name = $_GET['name'];
	        	$where .= " AND ung_vien.name like '%$name%'";
	        	$cond .= "&name=$name";
	        }

	        if (isset($_GET['code']) && $_GET['code'] != '') {
	        	$code = $_GET['code'];
	        	$where .= " AND ung_vien.id = '$code'";
	        	$cond .= "&code=$code";
	        }
	        ...
	        $sql = "SELECT * From $table INNER JOIN ho_so ON ung_vien.id = ho_so.ung_vien_id $where $order $limit1";
	        ...
	        if ($trang != "" && $limit != "") {
	            ...
	            $sql = "SELECT * from $table INNER JOIN ho_so ON ung_vien.id = ho_so.ung_vien_id $where $order limit $start, $limit";
	    ...
	    public function getList_admin_nhatuyen($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	        ...
	        if ($order_name != "" && $order_state != "") {
	            ...
	            $order = "group by nha_tuyen_dung.company order by $order_name $order_state ";
	        ...
	        if (isset($_GET['name'])) {
	        	$company = $_GET['name'];
	        	$where .= " AND nha_tuyen_dung.company like '%$company%'";
	        	$cond .= "&name=$company";
	        }

	        if (isset($_GET['code']) && $_GET['code'] != '') {
	        	$code = $_GET['code'];
	        	$where .= " AND nha_tuyen_dung.id = '$code'";
	        	$cond .= "&code=$code";
	        }

	        if (isset($_GET['level']) && $_GET['level']) {
	        	$level = $_GET['level'];
	        	$where .= " AND thong_tin_tuyen_dung.level = $level";
	        	$cond .= "&level=$level";
	        }
	        ...
	        $sql = "SELECT * From $table INNER JOIN thong_tin_tuyen_dung ON nha_tuyen_dung.id = thong_tin_tuyen_dung.nha_tuyen_dung_id $where $order $limit1";
	        ...
	        if ($trang != "" && $limit != "") {
	            ...
	            $sql = "SELECT * from $table INNER JOIN thong_tin_tuyen_dung ON nha_tuyen_dung.id = thong_tin_tuyen_dung.nha_tuyen_dung_id $where $order limit $start, $limit";
	    ...
	    public function getList_diff($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	    ...
	    public function getList_dontuyen($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	        ...
	        if ($id_Cat != "" && $name_idCat != "") {
	        	...
	        	// 	$where = " where 1=1";
	        	// } else {
	        		$where = " where $name_idCat='".$level."'";
	        	// }
	            /////////////
	        	
	        	if ($level == 0) {
	        		$where = " where level IN (6,7,8,9)";
	        	}
	        ...
	        if ($order_name != "" && $order_state != "") {
	            ...
	            $order = "order by thong_tin_tuyen_dung.$order_name $order_state ";

	        }
	        ///////////
	        $title = $_GET['title'];
	        $title_1 = $_GET['title'];
	        $title = $this->vi_en($title);
	        $title = str_replace(" ", "-", $title);
	        $career = $_GET['career'];
	        $location = $_GET['location'];
	        $where .= " AND (alias LIKE '%$title%' OR nha_tuyen_dung.company LIKE '%$title_1%')";
	        $cond .= "&title=$title";
	        if ($career != 0) {
	        	$where .= " AND career like '%$career%'";
	        	$cond .= "&career=$career";
	        }
	        if ($location != 0) {
	        ...
	        if (isset($_GET['experience']) && $_GET['experience'] != 0) {
	        	...
	        	$cond .= "&experience=".$_GET['experience'];
	        }
	        if (isset($_GET['office']) && $_GET['office'] != 0) {
	        	$where .= " AND office = ".$_GET['office'];
	        	$cond .= "&office=".$_GET['office'];
	        }
	        if (isset($_GET['form']) && $_GET['form'] != 0) {
	        	$where .= " AND form = ".$_GET['form'];
	        	$cond .= "&form=".$_GET['form'];
	        }
	        if (isset($_GET['luong']) && $_GET['luong'] != 0) {
	        	$where .= " AND salary = ".$_GET['luong'];
	        	$cond .= "&luong=".$_GET['luong'];
	        }

	        if (isset($_GET['sex'])) {
	        	if ($_GET['sex'] == 0) {
	        		$where .= " AND sex in (1, 2, 3)";
	        		$cond .= "&sex=0";
	        	} else {
	        		$sex = $_GET['sex'];
	        		$where .= " AND sex = $sex";
	        ...
	        if ($trang != "" && $limit != "") {
	            ...
	            $rows1 = array("data"=>$rows, "paging"=>$p, "count" => $total_record);
	    ...
	    public function getList_dontuyen_1($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	    ...
	    public function getList_dontuyen_diff($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	        ...
	        if ($id_Cat != "" && $name_idCat != "") {
	        	...
	        	if ($level == 0) {
	        		$where = " where level IN (1,2,3,4,5)";
	        	}
	    ...
	    public function getList_dontuyen_diff_1($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	    ...
	    public function getList_hoso($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	        ...
	        $career = $_GET['career'];
	        $location = $_GET['location'];
	        $where = " where (ho_so.alias LIKE '%$title%' OR ung_vien.name LIKE '%$title_1%')";
	        $cond .= "&title=$title";
	        if ($career != 0) {
	        	$where .= " AND ho_so.item like '%$career%'";
	        	$cond .= "&career=$career";
	        }
	        if ($location != 0) {
	        	$where .= " AND ho_so.dia_diem like '%$location%'";
	        	$cond .= "&location=$location";
	        }
	        if (isset($_GET['experience']) && $_GET['experience'] != 0) {
	        	$where .= " AND ho_so.experience = ".$_GET['experience'];
	        	$cond .= "&experience=".$_GET['experience'];
	        }
	        if (isset($_GET['office']) && $_GET['office'] != 0) {
	        	$where .= " AND ho_so.office = ".$_GET['office'];
	        	$cond .= "&office=".$_GET['office'];
	        }
	        if (isset($_GET['form'])) {
	        	$where .= " AND ho_so.form = ".$_GET['form'];
	        	$cond .= "&form=".$_GET['form'];
	        }
	        if (isset($_GET['lang']) && $_GET['lang'] != 0) {
	        	$where .= " AND ho_so.ngoai_ngu_tin_hoc = ".$_GET['lang'];
	        	$cond .= "&lang=".$_GET['lang'];
	        }
	        if (isset($_GET['luong']) && $_GET['luong'] != 0) {
	        	$where .= " AND ho_so.salary = ".$_GET['luong'];
	        	$cond .= "&luong=".$_GET['luong'];
	        }

	        if (isset($_GET['sex']) && $_GET['sex'] != 2) {
	        	$sex = $_GET['sex'];
	        	$where .= " AND ung_vien.sex = $sex";
	        	$cond .= "&sex=$sex";
	        }
	        if (isset($_GET['level']) && $_GET['level'] != 0) {
	        	$level = $_GET['level'];
	        	// if ($level == 1) {
	        	// 	$where .= " AND ung_vien.type = 1";
	        	// } else {
	        	// 	$where .= " AND ung_vien.type = 0 AND ho_so.level = $level";
	        	// }
	        	$where .= " AND ho_so.level = $level";
	        	$cond .= "&level=$level";
	        } else {
	        	
	        }
	        $where .= " AND ung_vien.type = $id_Cat";
	        ///////////
	        ...
	        $sql = "SELECT * From $table INNER JOIN ung_vien ON ho_so.ung_vien_id = ung_vien.id $where $order $limit1";
	        ...
	        if ($trang != "" && $limit != "") {
	            ...
	            $sql = "SELECT * from $table INNER JOIN ung_vien ON ho_so.ung_vien_id = ung_vien.id $where $order limit $start, $limit";
	    ...
	    public function getList_hoso_1($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	    ...
	    public function getList_hoso_2($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
	    ...
	    public function getList_hoso_3($table, $name_idCat, $id_Cat, $order_name, $order_state, $trang, $limit, $page, $slug = ''){
