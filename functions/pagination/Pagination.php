...
class Pagination
{
    ...
    {   
        ...
        if ($this->_config['total_record'] > $this->_config['limit'])
        {
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li><a href="'.$this->__link($this->_config['current_page'] + 1).'">Kế tiếp</a></li>';
    ...
    {   
        ...
        if ($this->_config['total_record'] > $this->_config['limit'])
        {
            ...
            if ($this->_config['current_page'] > 1)
            {
                $truoc = $this->_config['current_page']-1;
                $p .= '<li><a onclick="ajaxf(1)">Đầu</a></li>';
                $p .= '<li><a onclick="ajaxf('.$truoc.')">Trước</a></li>';
            }
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $sau = $this->_config['current_page'] + 1;
                $cuoi = $this->_config['total_page'];
                $p .= '<li><a onclick="ajaxf('.$sau.')">Kế tiếp</a></li>';
                $p .= '<li><a onclick="ajaxf('.$cuoi.')">Cuối</a></li>';
            }
    ...
    {   
        ...
        if ($this->_config['total_record'] > $this->_config['limit'])
        {
            ...
            if ($this->_config['current_page'] > 1)
            {
                $p .= '<li><a href="'.$this->__link1('1').'">Đầu</a></li>';
                $p .= '<li><a href="'.$this->__link1($this->_config['current_page']-1).'">Trước</a></li>';
            }
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li><a href="'.$this->__link1($this->_config['current_page'] + 1).'">Kế tiếp</a></li>';
                $p .= '<li><a href="'.$this->__link1($this->_config['total_page']).'">Cuối</a></li>';
            }
    ...
    {   
        ...
        if ($this->_config['total_record'] > $this->_config['limit'])
        {
            ...
            if ($this->_config['current_page'] > 1)
            {
                $p .= '<li><a href="'.$this->__link2('1').'">Đầu</a></li>';
                $p .= '<li><a href="'.$this->__link2($this->_config['current_page']-1).'">Trước</a></li>';
            }
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li><a href="'.$this->__link2($this->_config['current_page'] + 1).'">Kế tiếp</a></li>';
                $p .= '<li><a href="'.$this->__link2($this->_config['total_page']).'">Cuối</a></li>';
            }
    ...
    {   
        ...
        if ($this->_config['total_record'] > $this->_config['limit'])
        {
            ...
            if ($this->_config['current_page'] > 1)
            {
                $p .= '<li><a href="'.$this->__link3('1').'">Đầu</a></li>';
                $p .= '<li><a href="'.$this->__link3($this->_config['current_page']-1).'">Trước</a></li>';
            }
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li><a href="'.$this->__link3($this->_config['current_page'] + 1).'">Kế tiếp</a></li>';
                $p .= '<li><a href="'.$this->__link3($this->_config['total_page']).'">Cuối</a></li>';
            }
    ...
    {   
        ...
        if ($this->_config['total_record'] > $this->_config['limit'])
        {
            ...
            if ($this->_config['current_page'] > 1)
            {
                $p .= '<li><a href="'.$this->__link4('1').'">Đầu</a></li>';
                $p .= '<li><a href="'.$this->__link4($this->_config['current_page']-1).'">Trước</a></li>';
            }
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li><a href="'.$this->__link4($this->_config['current_page'] + 1).'">Kế tiếp</a></li>';
                $p .= '<li><a href="'.$this->__link4($this->_config['total_page']).'">Cuối</a></li>';
            }
    ...
    {   
        ...
        if ($this->_config['total_record'] > $this->_config['limit'])
        {
            ...
            if ($this->_config['current_page'] > 1)
            {
                $p .= '<li><a href="'.$this->__link_tuan($link, '1').'">Đầu</a></li>';
                $p .= '<li><a href="'.$this->__link_tuan($link, $this->_config['current_page']-1).'">Trước</a></li>';
            }
            ...
            if ($this->_config['current_page'] < $this->_config['total_page'])
            {
                $p .= '<li><a href="'.$this->__link_tuan($link, $this->_config['current_page'] + 1).'">Kế tiếp</a></li>';
                $p .= '<li><a href="'.$this->__link_tuan($link, $this->_config['total_page']).'">Cuối</a></li>';
            }
