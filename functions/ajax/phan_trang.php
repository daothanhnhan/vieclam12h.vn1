<?php 
	...
	$ung_vien_moi = $action->getList_ajax('ung_vien', 'type', '0', 'time', 'desc', $_GET['trang'], '20', 'a');
?>
                        <h2 class="gb-page-sanpham_ruouvang-title" style="background-color: #0091cf; color: #fff;"><i class="fa fa-user-circle-o" aria-hidden="true" style="    color: #fff;"></i> Ứng viên mới</h2>
