...
<div class="gb-search-filter-vieclam  hidden-sm hidden-xs">
    <div class="container">
        <form action="/index.php" method="get" accept-charset="utf-8">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group search-diadiemheader">
                                <select name="career" class="selectpicker form-control" data-show-subtext="true" data-live-search="true">
                                    <option value="0" data-icon="icon-hammer-wrench">Tìm theo ngành nghề</option>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <span style="color: #fff;display: <?= $_GET['page']!='tim-kiem' ? 'none' : ''; ?>;">Bạn đang tìm kiếm việc làm trang tuyển dụng</span>
                    <button id="btn-tim" type="button" data-toggle="collapse" data-target="#demo1">Tìm kiếm nâng cao</button>
                </div>
            </div>
            <div id="demo1" class="row collapse">
                <div class="col-sm-4">
                    <div class="form-group search-diadiemheader">
