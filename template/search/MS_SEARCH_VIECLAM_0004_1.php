...
<div class="gb-search-filter-vieclam">
    <div class="container">
        <form action="/index.php" method="get" accept-charset="utf-8">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <span style="color: #fff;display: <?= $_GET['page']!='tim-kiem-ung-vien' ? 'none' : ''; ?>;">Bạn đang tìm kiếm ứng viên có trình độ</span>
                    <button type="button" id="btn-tim" data-toggle="collapse" data-target="#demo2">Tìm kiếm nâng cao</button>
                </div>
            </div>
            <div id="demo2" class="row collapse">
                <div class="col-sm-4">
                    <div class="form-group search-diadiemheader">
                ...
                <div class="col-sm-4">
                    <div class="form-group search-diadiemheader">
                        <select name="level" class="selectpicker form-control" data-show-subtext="true" data-live-search="true">
                            ...
                            <?php foreach ($search_level as $item) { ?>
                            <option value="<?= $item['id'] ?>" ><?= $item['name'] ?></option>
                            <?php } ?>
                        </select>
                    </div>
