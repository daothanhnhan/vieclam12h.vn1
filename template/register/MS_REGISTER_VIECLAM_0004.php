<?php 
    ...
    function dang_ky () {
        ...
        if (isset($_POST['ungvien'])) {
            ...
            if ($check == "true") {
                ...
                if ($result) {
                    $sql_user = "SELECT * FROM ung_vien Where phone = '$phone'";
                    $result_user = mysqli_query($conn_vn, $sql_user);
                    $row_user = mysqli_fetch_assoc($result_user);
                    $_SESSION['user_id_gbvn'] = $row_user['id'];
                    $_SESSION['user_phone_gbvn'] = $row_user['phone'];
    ...
    function cap_nhat ($id) {
        ...
        if (isset($_POST['edit_ungvien'])) {
            ...
            if ($check == "true") {
                ...
                $result = mysqli_query($conn_vn, $sql);//echo $sql;
                if ($result) {
    ...
    if (isset($_SESSION['user_id_gbvn']) && $_SESSION['user_type_gbvn'] == 2) {
        ...
        if ($info['type']==0) {
            header('location: /dang-ky-ung-vien-co-trinh-do');
        }
        $name = $info['name'];
        $email = $info['email'];
        $phone = $info['phone'];
    ...
    function add_hoso () {
        ...
        if (isset($_POST['add_hoso'])) {
            ...
            if ($count_hoso > 0) {
                ...
                $sql = "INSERT INTO ho_so (ung_vien_id, school, career, year, skill, work_progress, experience, salary, form, address, cv, position, item, dia_diem, alias, hon_nhan, created_at, muc_tieu, loai_nganh, level, office) VALUES ($ung_vien_id, '$school', '$career', $year, '$skill', '$work_progress', '$experience', '$salary', $form, '$address', '$cv', '$position', '$item', '$dia_diem', '$alias', $hon_nhan, '$ngay', '$muc_tieu', $loai_nganh, $level, $office)";
                $result = mysqli_query($conn_vn, $sql);
                if ($result) {
    ...
    function edit_hoso ($id) {
        ...
        if (isset($_POST['edit_hoso'])) {
            ...
            if ($cv == '') {
                $sql = "UPDATE ho_so SET school = '$school', career = '$career', year = $year, skill = '$skill', work_progress = '$work_progress', experience = '$experience', salary = '$salary', form = $form, address = '$address', position = '$position', item = '$item', dia_diem = '$dia_diem', alias = '$alias', hon_nhan = $hon_nhan, created_at = '$ngay', muc_tieu = '$muc_tieu', loai_nganh = $loai_nganh, level = $level, office = $office WHERE ung_vien_id = $id";
            } else {
                $sql = "UPDATE ho_so SET school = '$school', career = '$career', year = $year, skill = '$skill', work_progress = '$work_progress', experience = '$experience', salary = '$salary', form = $form, address = '$address', position = '$position', item = '$item', dia_diem = '$dia_diem', alias = '$alias', hon_nhan = $hon_nhan, created_at = '$ngay', muc_tieu = '$muc_tieu', loai_nganh = $loai_nganh, level = $level, office = $office, cv = '$cv' WHERE ung_vien_id = $id";
            }
...
<div class="gb-dangky-ungvien">
    <div class="container">
        <h1>Ưng viên phổ thông đăng ký việc làm</h1>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="email" name="email" value="<?= $email ?>" class="form-control" placeholder=""  <?= $loai_ungvien == 1 ? 'readonly' : '' ?>  >
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <?php if ($loai_ungvien == 1) { ?>
                                    <input type="submit" name="edit_ungvien" value="CẬP NHẬT" class="form-control" style="font-weight: bold;">
                                    <?php } else { ?>
                                    <input type="submit" name="ungvien" value="ĐĂNG KÝ" class="form-control" required  style="font-weight: bold;">
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-10 col-sm-offset-1">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-4">
                                    <label>Tốt nghiệp trường <span style="color: red;"></span></label>
                                </div>
                                <div class="col-sm-8">
                                    <input type="text" name="school" value="<?= $school ?>" class="form-control" >
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <select name="level" id="level" class="form-control" required>
                                        ...
                                        <option value="6" <?= $level==6 ? 'selected' : '' ?> >THCS/THPT</option>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control" name="muc_tieu" rows="5" ><?= $muc_tieu ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <!-- <div class="form-group">
                            <div class="row">
                                <div class="col-sm-4">
                                    <label>CV đính kèm <span style="color: red;">*</span></label>
                                </div>
                                <div class="col-sm-8">
                                    <?php if (isset($_SESSION['user_id_gbvn']) && $_SESSION['user_type_gbvn'] == 2) { ?>
