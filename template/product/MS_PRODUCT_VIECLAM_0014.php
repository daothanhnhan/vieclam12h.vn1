<?php 
    ...
    // }
    /////////////////////////
    $co_trinh_do_1 = $action->getList_hoso_1('ho_so','type','0','ho_so.id','desc','','72', '');
    $co_trinh_do_2 = $action->getList_hoso_2('ho_so','type','0','ho_so.id','desc','','72', '');
    $co_trinh_do_3 = $action->getList_hoso_3('ho_so','type','0','ho_so.id','desc','','72', '');
    $koco_trinh_do = array();
