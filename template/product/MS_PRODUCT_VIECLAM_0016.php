<?php                                                                        
    ...
    /////////////////
    if ($_GET['level'] == 0) {
        $koco_trinh_do = $action->getList_dontuyen_1('thong_tin_tuyen_dung','level','1','id','desc','','72','');
        $co_trinh_do = $action->getList_dontuyen_diff_1('thong_tin_tuyen_dung','level','1','id','desc','','72', '');
    } else {
        if ($_GET['level'] == 1) {
            $koco_trinh_do = $action->getList_dontuyen_1('thong_tin_tuyen_dung','level','1','id','desc','','72','');
            $co_trinh_do = array();
            ...
            $koco_trinh_do = array();
            $co_trinh_do = $action->getList_dontuyen_diff_1('thong_tin_tuyen_dung','level',$_GET['level'],'id','desc','','72', '');
        }
    }
