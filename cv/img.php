...
class Img
{
    ...
    public function text () {
        $textcolor = imagecolorallocate($this->img, 230, 32, 42);
        $font_file = 'Arial.ttf';
        $custom_text = "Watermark Text";
        imagettftext($this->img, 50, 0, 0, 100, $textcolor, $font_file, $custom_text);
        // imagestring($this->img, 60, 50, 50,  'A Simple Text String', $textcolor);
