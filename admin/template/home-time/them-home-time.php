<?php 
	...
	function goi_diem () {
		...
		if (isset($_POST['add_goidiem'])) {
			...
			$sql = "INSERT INTO bang_gia_3 (week, price) VALUES ('$week', '$price')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một gói tuần.\');window.location.href="index.php?page=home-time"</script>';
			} else {
