<?php 
	...
	function hotline () {
		...
		if (isset($_POST['add_hotline'])) {
			...
			$sql = "INSERT INTO hotline_nam (name, phone) VALUES ('$name', '$phone')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một Hotline.\');window.location.href="index.php?page=hotline-nam"</script>';
			} else {
