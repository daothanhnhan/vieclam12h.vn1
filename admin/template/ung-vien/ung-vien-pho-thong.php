<?php
    if (isset($_GET['name'])) {
        $rows = $acc->getList_admin_ungvien("ung_vien","type","1","ung_vien.id","desc",$trang, 20, "ung-vien-pho-thong");//var_dump($rows);
    } else {
        $rows = $acc->getList("ung_vien","type","1","id","desc",$trang, 20, "ung-vien-pho-thong");//var_dump($rows);
    }
?>  
    <div class="boxPageNews">
        <h1><a href="index.php?page=them-ung-vien-pho-thong">Thêm ứng viên phổ thông</a></h1>
        <div class="row" style="clear: both;">
            <form action="" method="get">
                <input type="hidden" name="page" value="ung-vien-pho-thong">
                <div class="col-sm-2">
