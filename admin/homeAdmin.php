<?php
    ...
    $ntd = $action->getList('nha_tuyen_dung', '', '', 'id', 'asc', '', '', '');
    $ntd_count = count($ntd);
    $co_trinh_do = $action->getList('ung_vien', 'type', '0', 'id', 'asc', '', '', '');//var_dump($co_trinh_do);
    $co_trinh_do_count = count($co_trinh_do);
    $ko_co_trinh_do = $action->getList('ung_vien', 'type', '1', 'id', 'asc', '', '', '');
    $ko_co_trinh_do_count = count($ko_co_trinh_do);
?>			
            ...
            <ul class="listTopDashboard"> 
            	<li class="DB1">
                	<a href="#" class="linkDB">
                        ...
                        <p class="numDB"><?php echo $ntd_count;?></p>
                        <p class="nameDB">Nhà tuyển dụng</p>
                    </a>                    
                </li>
            	<li class="DB2">
                	<a href="#" class="linkDB">
                        <img src="image/db2.png" class="imgDB" />
                        <p class="numDB"><?= $co_trinh_do_count ?></p>
                        <p class="nameDB">Ứng viên có trình độ</p>
                    </a>                    
                </li>
            	<li class="DB3">
                	<a href="#" class="linkDB">
                        <img src="image/db3.png" class="imgDB" />
                        <p class="numDB"><?php echo $ko_co_trinh_do_count;?></p>
                        <p class="nameDB">Lao động phổ thông</p>
                    </a>                    
                </li>
            	<li class="DB4">
                	<a href="#" class="linkDB">
