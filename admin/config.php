                            ...
                            <?php 
                                ...
                                ?>
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <input type="hidden" name="lang[<?= $lang['languages_code']?>][lang_content_home11]" value="">
...
<form action="" method="post" enctype="multipart/form-data" id="updateConfig">
    ...
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            <span class="titLeftNCP">Icon Nhân viên</span>
            <p class="subLeftNCP">Thay banner cho website<br /><br /></p>                         
        </div>
        <div class="boxNodeContentPage">
            <div id="wrapper">
                <input id="fileUpload7" type="file" name="fileUpload7"/>
                <br />
                <div id="image-holder">
                <?php 
                    if ($rowConfig['banner4'] != '') {
                    ?>
                        <img src="../images/<?= $rowConfig['banner4']?>" class="img-responsive" alt="Image" width="200">
                        <input type="hidden" name="banner4" value="<?= $rowConfig['banner4']?>">
                    <?php
                    }
                ?>                
                </div>
    ...
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            <span class="titLeftNCP">Banner5 (mua tin)</span>
            <p class="subLeftNCP">Thay banner cho website<br /><br /></p>                         
        </div>
        <div class="boxNodeContentPage">
            <div id="wrapper">
                <input id="fileUpload8" type="file" name="fileUpload8"/>
                <br />
                <div id="image-holder">
                <?php 
                    if ($rowConfig['banner5'] != '') {
                    ?>
                        <img src="../images/<?= $rowConfig['banner5']?>" class="img-responsive" alt="Image" width="200">
                        <input type="hidden" name="banner5" value="<?= $rowConfig['banner5']?>">
                    <?php
                    }
                ?>                
                </div>
    ...
    <div class="rowNodeContentPage">
        <div class="leftNCP">
            <span class="titLeftNCP">Banner6 (trang quản lý)</span>
            <p class="subLeftNCP">Thay banner cho website<br /><br /></p>                         
        </div>
        <div class="boxNodeContentPage">
            <div id="wrapper">
                <input id="fileUpload9" type="file" name="fileUpload9"/>
                <br />
                <div id="image-holder">
                <?php 
                    if ($rowConfig['banner6'] != '') {
                    ?>
                        <img src="../images/<?= $rowConfig['banner6']?>" class="img-responsive" alt="Image" width="200">
                        <input type="hidden" name="banner6" value="<?= $rowConfig['banner6']?>">
                    <?php
                    }
                ?>                
                </div>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Số chuyên viên hỗ trợ</p>
            <input type="text" class="txtNCP1" value="<?php echo $row_showMain['lang_content_home10']?>" name="content_home10"/>

            <p class="titleRightNCP">Tên chuyên viên hỗ trợ</p>
            <input type="text" class="txtNCP1" value="<?php echo $row_showMain['lang_content_home11']?>" name="content_home11"/>
            ...
            <p class="titleRightNCP">Text trang tuyển</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['text_1']?>" name="text_1"/>

            <p class="titleRightNCP">Text trang ứng viên</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['text_2']?>" name="text_2"/>
        </div>
    </div><!--end rowNodeContentPage-->
