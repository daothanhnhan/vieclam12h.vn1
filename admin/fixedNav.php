    ...
    <div class="contentFL">
        <ul class="listMenuFL">
           ...
           <!-- <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <li><a href="index.php?page=nha-tuyen-dung" title="" class="linkMenu <?php if ($_GET["page"] == 'nha-tuyen-dung') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhà tuyển dụng</a>
            </li>

            <li><a href="index.php?page=ung-vien-co-trinh-do" title="" class="linkMenu <?php if ($_GET["page"] == 'ung-vien-co-trinh-do') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Ứng viên có trình độ</a>
            </li>

            <li><a href="index.php?page=ung-vien-pho-thong" title="" class="linkMenu <?php if ($_GET["page"] == 'ung-vien-pho-thong') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Ứng viên phổ thông</a>
            </li>
            <!-- tab menu -->
            ...
            <li><a href="index.php?page=dia-diem" title="" class="linkMenu <?php if ($_GET["page"] == 'dia-diem') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Địa điểm</a>
            </li>

            <li><a href="index.php?page=chuc-vu" title="" class="linkMenu <?php if ($_GET["page"] == 'chuc-vu') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Chức vụ</a>
            </li>

            <li><a href="index.php?page=slide" title="" class="linkMenu <?php if ($_GET["page"] == 'slide') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Banner</a>
            </li>

            <li><a href="index.php?page=hotline-bac" title="" class="linkMenu <?php if ($_GET["page"] == 'hotline-bac') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Hotline miền Bắc</a>
            </li>

            <li><a href="index.php?page=hotline-nam" title="" class="linkMenu <?php if ($_GET["page"] == 'hotline-nam') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Hotline miền Nam</a>
            </li>

            <li><a href="index.php?page=slideshow" title="" class="linkMenu <?php if ($_GET["page"] == 'slideshow') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>SlideShow</a>
            </li>

            <li><a href="index.php?page=goi-diem" title="" class="linkMenu <?php if ($_GET["page"] == 'goi-diem') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Gói điểm</a>
            </li>

            <li><a href="index.php?page=book-diem" title="" class="linkMenu <?php if ($_GET["page"] == 'book-diem') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Kích hoạt gói điểm</a>
            </li>

            <li><a href="index.php?page=home-time" title="" class="linkMenu <?php if ($_GET["page"] == 'home-time') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Báo giá trang chủ</a>
            </li>

            <li><a href="index.php?page=book-home" title="" class="linkMenu <?php if ($_GET["page"] == 'book-home') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Tin mua trang chủ</a>
            </li>

            

            <li><a href="index.php?page=tuyen-time" title="" class="linkMenu <?php if ($_GET["page"] == 'tuyen-time') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Báo giá trang tuyển</a>
            </li>

            <li><a href="index.php?page=book-tuyen" title="" class="linkMenu <?php if ($_GET["page"] == 'book-tuyen') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Tin mua trang tuyển</a>
            </li>
            <?php } else { ?>
            <li><a href="index.php?page=nha-tuyen-dung" title="" class="linkMenu <?php if ($_GET["page"] == 'nha-tuyen-dung') { echo 'sltMenu'; } ?>"
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nhà tuyển dụng</a>
