...
class action_page extends library{
	...
	/*-------------- Cấu hình trang chủ --------------------*/
		...
		public function updateConfig(){
			...
			$text_2 = isset($_POST['text_2']) ? $_POST['text_2'] : '';
	    	...
	    	if (isset($_FILES['fileUpload7']) && $_FILES['fileUpload7']['name'] != "") {

	    		$src= "../images/";

		    	$img = $_FILES['fileUpload7'];
	    		...
	    		$banner4 = isset($_POST['banner4']) ? $_POST['banner4'] : '';

	    	}

	    	if (isset($_FILES['fileUpload8']) && $_FILES['fileUpload8']['name'] != "") {

	    		$src= "../images/";

		    	$img = $_FILES['fileUpload8'];
	    		...
	    		$banner5 = isset($_POST['banner5']) ? $_POST['banner5'] : '';

	    	}

	    	if (isset($_FILES['fileUpload9']) && $_FILES['fileUpload9']['name'] != "") {

	    		$src= "../images/";

		    	$img = $_FILES['fileUpload9'];
	    		...
	    		$banner6 = isset($_POST['banner6']) ? $_POST['banner6'] : '';
